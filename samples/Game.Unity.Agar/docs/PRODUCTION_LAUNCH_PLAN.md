...
本文面向 `samples/Game.Unity.Agar` 从“可演示样例”推进到“小规模生产上线”的评审。现有阶段计划见 `DEVELOPMENT_PLAN.md`；本文只回答上线前还缺哪些功能、还需要做哪些工程和验证工作。
...
- 选定网关间事件机制：优先评估 Redis 发布订阅、Lakona.Game.Cluster 或应用自定义消息总线，明确输入转发、世界状态扇出、断线事件和背压所有权。
