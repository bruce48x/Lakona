# Game.Cluster.TwoNode

`Game.Cluster.TwoNode` is a minimal cross-process Lakona.Game cluster smoke sample.
...
```powershell
dotnet run --project samples/Game.Cluster.TwoNode/Cluster.TwoNode.csproj -- --mode driver
```
