...
3. Locate the stable App and Hotfix projects. Inspect their project properties,
   ...
   dependency registration, and validation commands.
...
9. Add or update focused behavioral tests when the project has a service or
   domain test surface.
10. Build the discovered Hotfix project and run the focused tests. Report what
...
availability or runtime publication cannot be proven statically.
