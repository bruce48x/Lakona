...
**Key releases:** `Lakona Hub 0.2.5`, `Lakona.ProjectSystem 0.1.7`, and
`Lakona.Tool 0.25.27`.
...
- Replaced runtime bitmap branding with a vector icon so Linux and macOS
  NativeAOT smoke tests can initialize the Hub window and publish releases.
