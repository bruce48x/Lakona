...
In MemoryPack mode, Shared DTOs include MemoryPack annotations and the starter writes the related dependencies into the project. DTO versioning needs more care; see [DTO Versioning](/rpc/posts/dto-versioning/).
