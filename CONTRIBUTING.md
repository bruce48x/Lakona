...
| [docs/tool/package-version-graph.md](./docs/tool/package-version-graph.md) | Graph-based package version bump guard for local NuGet dependency closure changes |
