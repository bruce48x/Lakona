...
namespace Lakona.Game.Server.Hotfix.Generators
{
    ...
    public sealed class HotfixGenerator : IIncrementalGenerator
    {
            ...
            bool isPost)
        {
            ...
            builder.AppendLine("(");
            builder.Append("                    typeof(").Append(actorType).AppendLine("), method.MethodName, actor,");
            builder.AppendLine("                    method.PassCancellationToken ? new global::System.Type[] { typeof(TRequest), typeof(global::System.Threading.CancellationToken) } : new global::System.Type[] { typeof(TRequest) },");
            builder.AppendLine("                    method.PassCancellationToken ? new object[] { value, innerCt } : new object[] { value }),");
            builder.Append("                ct)");
        ...
        private static void AppendHotfixDistributedCallNoResultHelper(StringBuilder builder, HotfixActorApiInfo contract)
        {
            ...
            builder.AppendLine("                    method.PassCancellationToken");
            builder.AppendLine("                        ? new object[] { request, cancellationToken }");
